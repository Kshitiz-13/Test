...
import styles from "./AchievementsEdit.module.css";

const AchievementsEdit: FunctionComponent = () => {
  ...
  return (
    <div className={styles.achievementsEdit}>
      ...
      <div className={styles.frameDiv13}>
        <div className={styles.frameDiv14}>
          <b className={styles.editAchievementB}>Edit achievement</b>
        </div>
        <div className={styles.frameDiv15}>
          <div className={styles.titleDiv}>Title</div>
          <div className={styles.groupDiv6}>
            <div className={styles.rectangleDiv8} />
            <div className={styles.selectClassesThis4}>Created Batmobile</div>
          </div>
        </div>
        <div className={styles.frameDiv16}>
          <div className={styles.frameDiv2}>
            <div className={styles.titleDiv}>Date</div>
            <div className={styles.groupDiv7}>
              <div className={styles.rectangleDiv8} />
              <div className={styles.may2019Div}>May 2019</div>
            </div>
          </div>
        </div>
        <div className={styles.frameDiv15}>
          <div className={styles.titleDiv}>Description</div>
        ...
        <div className={styles.frameDiv19} onClick={onFrameContainer18Click}>
