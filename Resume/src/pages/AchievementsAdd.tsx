...
import styles from "./AchievementsAdd.module.css";

const AchievementsAdd: FunctionComponent = () => {
  ...
  return (
    <div className={styles.achievementsAdd}>
      ...
      <div className={styles.frameDiv13}>
        <div className={styles.frameDiv14}>
          <b className={styles.addNewAchievement}>Add new achievement</b>
        </div>
