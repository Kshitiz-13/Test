...
import styles from "./WorkExpAdd.module.css";

const WorkExpAdd: FunctionComponent = () => {
  ...
  return (
    <div className={styles.workExpAdd}>
      <div className={styles.profileSectionDiv}>
        <div className={styles.rectangleDiv} />
        <div className={styles.frameDiv}>
          <img className={styles.groupIcon} alt="" src="../group-103.svg" />
      ...
      <div className={styles.frameDiv13}>
        <div className={styles.frameDiv14}>
          <b className={styles.addNewWorkExperience}>Add new work experience</b>
        </div>
        <div className={styles.frameDiv11}>
