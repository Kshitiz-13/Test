...
import styles from "./WorkExpEdit.module.css";

const WorkExpEdit: FunctionComponent = () => {
  ...
  return (
    <div className={styles.workExpEdit}>
      <div className={styles.profileSectionDiv}>
        <div className={styles.rectangleDiv} />
        <div className={styles.frameDiv}>
          <img className={styles.groupIcon} alt="" src="../group-101.svg" />
      ...
      <div className={styles.frameDiv13}>
        <div className={styles.frameDiv14}>
          <b className={styles.editWorkExperience}>Edit work experience</b>
        </div>
        <div className={styles.frameDiv11}>
        ...
        <div className={styles.frameDiv11}>
          <div className={styles.companyDiv}>Role</div>
          <div className={styles.groupDiv7}>
            <div className={styles.rectangleDiv8} />
            <div className={styles.techLeadDiv}>Tech Lead</div>
          </div>
        </div>
        <div className={styles.frameDiv17}>
          <div className={styles.frameDiv2}>
            <div className={styles.companyDiv}>Start date</div>
            <div className={styles.groupDiv7}>
          ...
          <div className={styles.frameDiv2}>
            <div className={styles.companyDiv}>End date</div>
            <div className={styles.groupDiv7}>
              <div className={styles.rectangleDiv10} />
        ...
        <div className={styles.frameDiv11}>
          <div className={styles.companyDiv}>Description</div>
          <div className={styles.groupDiv10}>
            <div className={styles.rectangleDiv12} />
            <div
              className={styles.loremIpsumIsSimplyDummyTe2}
            >{`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. `}</div>
          </div>
        </div>
        <div className={styles.frameDiv21} onClick={onFrameContainer20Click}>
